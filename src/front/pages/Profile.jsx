...
export const Profile = () => {
  // Datos de usuario simulados (puedes cambiarlo a fetch o contexto)
  const [userData, setUserData] = useState(null);

  // Estado para las nuevas contraseñas
  ...
  useEffect(() => {
    // Simula la carga de datos reales
    const mockUser = {
      usuario: "juan123",
      nombre: "Juan",
  ...
  // Maneja el submit del cambio de contraseña
      ...
      <div style={{
        ...
        <section style={{ marginBottom: "20px" }}>
          ...
          <form onSubmit={handlePasswordChange} style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
            ...
            {passwordSuccess && (
              <p style={{ color: "lightgreen", fontWeight: "600", margin: 0 }}>{passwordSuccess}</p>
            )}
