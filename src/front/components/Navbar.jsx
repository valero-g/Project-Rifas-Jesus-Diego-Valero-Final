...
export const Navbar = () => {
    ...
    }, [menuOpen, cartHovered]);

    const cartItems = []; // Deja este array vacío para ver el mensaje "carrito vacío"
        ...
        <nav style={{ backgroundColor: "rgb(10,19,31)", padding: "10px 0", width: "100%" }}>
            ...
            >
                ...
                <div className="d-flex align-items-center" style={{ marginRight: 0 }}>
                    ...
                    {/* Contenedor del carrito para el pop-up y el enlace */}
                    <div
                        ...
                        ref={cartButtonRef}
                    >
                        {/* El icono del carrito ahora es un Link */}
                        <Link
                            to="/checkout" // Esta es la ruta a tu página de carrito
                            aria-label="Ir al carrito de compra"
                            style={{
                                background: "none",
                                border: "none",
                                cursor: "pointer",
                                color: "rgb(59,255,231)",
                                fontSize: "1.8rem",
                                textDecoration: "none", // Remueve el subrayado del Link
                                display: "inline-block", // Asegura que el span de la cantidad se posicione correctamente
                            }}
                            // Removemos el onClick que tenía el alert, ahora el Link se encarga
                        >
                            <svg
                            ...
                            {totalCartItems > 0 && (
                                <span style={{
                                    ...
                                    fontSize: '0.7em',
                                    fontWeight: 'bold',
                                    lineHeight: '1', // Ajusta para que el texto se centre verticalmente
                                }}>
                                    {totalCartItems}
                                </span>
                            )}
                        ...
                        {cartHovered && (
                            ...
                            >
                                {totalCartItems === 0 ? (
                                    <p style={{ color: "white", margin: 0 }}>El carrito está vacío.</p>
                                ) : (
                                    <Link to="/checkout" style={{ display: 'block' }}>
                                        <button
                                            className="btn"
                                            style={{ backgroundColor: "rgb(59,255,231)", color: "black", width: '100%' }}
